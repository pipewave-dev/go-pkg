...
- Cấp phát mọi sub-config về zero-value non-nil trước khi validate:
...
- Cân nhắc thêm: block bắt buộc (Valkey/DynamoDB/Postgres) mà thiếu thì báo lỗi rõ ràng thay vì im lặng dùng zero-value.
