...
| 10 | Pub/Sub không reconnect → mất message âm thầm | 🟠 High | Pubsub | [10-pubsub-no-reconnect-message-loss.md](10-pubsub-no-reconnect-message-loss.md) | ✅ Đã xử lý |
...
| 12 | Token kết nối tái sử dụng + lộ qua URL | 🟡 Medium | Security | [12-conn-token-replay-and-url-leak.md](12-conn-token-replay-and-url-leak.md) | ✅ Đã xử lý |
| 13 | Heartbeat/Ack/ping bỏ qua rate limit | 🟡 Medium | Security | [13-heartbeat-ack-ping-bypass-ratelimit.md](13-heartbeat-ack-ping-bypass-ratelimit.md) | ✅ Đã xử lý |
| 14 | `CleanUp` luôn trả nil + luôn log Error | 🟡 Medium | Error handling | [14-cleanup-returns-nil-and-noisy-log.md](14-cleanup-returns-nil-and-noisy-log.md) | ✅ Đã xử lý |
| 15 | Cửa sổ mất message ở msg-hub `Consume` | 🟡 Medium | Messaging | [15-msghub-consume-message-loss-window.md](15-msghub-consume-message-loss-window.md) | ✅ Đã xử lý |
...
| 20 | Nhóm Low / chất lượng code | 🟢 Low | Nhiều | [20-low-priority-and-quality.md](20-low-priority-and-quality.md) | ✅ Đã xử lý |
